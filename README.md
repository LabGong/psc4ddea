...
|      Algorithm      |                            Paper                             |                     Original Repository                      |
| :-----------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
|    DASE  | Data-Driven Evolutionary Computation Under Continuously Streaming Environments: A Drift-Aware Approach *2025* [paper]([https://ieeexplore.ieee.org/document/10644136)](https://ieeexplore.ieee.org/document/11082370) |                              [YTALEIN/DASE](https://github.com/YTALIEN/DASE) |
